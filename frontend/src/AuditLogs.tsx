  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-2 mt-4 border-b border-[#E7E1B1] font-mono text-xs w-full">
          <button
          ...
          >
            Live Incident Flight Recorder (Redis)
          </button>
        </div>
        {activeTab === "audit" ? (
          <>
            ...
            >
              <div className="text-[#306D29]">
                Showing{" "}
                <span className="font-bold text-[#0D530E]">{logs.length}</span>{" "}
                of{" "}
